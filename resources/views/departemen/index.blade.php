                                            ...
                                            <div class="col-10">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="nama_dept"
                                                        id="nama_dept" placeholder="Cari Departemen.."
                            ...
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    <span class="input-icon-addon">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="icon icon-tabler icon-tabler-barcode" width="40" height="40"
                                    ...
                                    <input type="text" value="" class="form-control"
                                        placeholder="Kode Departemen.." name="kode_dept" id="kode_dept">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button class="btn btn-primary w-100"><svg xmlns="http://www.w3.org/2000/svg"
                                            class="icon icon-tabler icon-tabler-send" width="40" height="40"
                                            viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                            stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
