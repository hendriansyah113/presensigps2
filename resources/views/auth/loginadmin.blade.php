                    ...
                    <div class="col-lg-5 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            <div class="brand-logo">
                                <img src="{{ asset('assets-purple/images/logo.svg') }}">
                            </div>
                            <h4>Hallo, Selamat Datang Administrator</h4>
                            ...
                            @endif
                            <form class="pt-3" method="POST" action="/prosesloginadmin">
                                @csrf
                                ...
                                <div class="my-2 d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ asset('assets-purple/') }}#" class="auth-link text-black">Forgot
                                        password?</a>
                                </div>
                            </form>
                        </div>
